...
- **계산 효율성:** 각 에이전트는 오직 자신의 국소 범위($r$) 내의 이웃하고만 통신하므로, 적절한 공간 분할 자료구조(Grid, Octree)를 사용하면 $O(n)$ 또는 $O(n \log n)$ 수준의 선형 확장성을 유지할 수 있습니다.
- **시각적 매력성:** 자연에서 관찰되는 유기적이고 역동적인 움직임을 수학적으로 재현하여 시각적으로 매우 아름답고 설득력 있는 애니메이션을 생성합니다.
