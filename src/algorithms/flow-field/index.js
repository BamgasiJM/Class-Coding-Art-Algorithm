...
export default {
  ...
  longDescription: {
    ko: String.raw`
**Flow Field**는 공간상의 각 좌표에 특정한 방향과 힘을 가진 벡터를 할당하여, **입자나 유체가 흐르는 듯한 움직임을 시뮬레이션**하는 알고리즘입니다. 단순한 노이즈 함수를 벡터장으로 변환함으로써 자연스러운 유체 흐름, 바람, 혹은 눈에 보이지 않는 에너지의 흐름을 시각화할 수 있습니다.
