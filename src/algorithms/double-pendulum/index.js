...
export default {
  longDescription: {
    ko: String.raw`
**Double Pendulum(이중 진자)**은 두 개의 강체 진자가 관절로 연결된 시스템으로, **라그랑주 역학(Lagrangian Mechanics)**으로부터 유도된 **비선형 연립 미분방정식**으로 기술되는 **결정론적 카오스(Deterministic Chaos)**의 가장 유명한 예시입니다. 초기 조건의 극미세한 차이(예: 각도 0.001 라디안)도 시간이 경과함에 따라 기하급수적으로 증폭되어 완전히 다른 궤적으로 발산하며, 이러한 현상을 **나비효과(Butterfly Effect)**라 부르며 혼돈 이론의 핵심을 보여줍니다. 끝점의 궤적은 절대로 반복되지 않는 극도로 복잡한 패턴을 그립니다.
